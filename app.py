...
def sendmail(body):
	...
	message['Subject'] = 'Warning IDS Alert'
	message['From'] = 'sistu8228@gmail.com'                          # Replace i (for email alerts, turn on Less secure app access in gmail, create a new google account for this purpose)
	password = 'istu4788'				       # Replace ii
	message['To'] = 'istiyakshaikh3032.is@gmail.com'                          # Replace iii
	body_content = body
